    ...
    (function (app) {
        ...
        app.generarBarraNavegacion = function () {
            $('#barraNavegacion').html('<nav class="navbar navbar-default" role="navigation">' +
                    ...
                    '<span class="icon-bar"></span>' +
                    '</button>' +
                    '<a class="navbar-brand active" href="http://localhost/DBF01/index.html">Pagina Principal</a>' +
                    '</div>' +
                    '<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">' +
                    '<ul class="nav navbar-nav">' +
                    '<li><a href = "http://localhost/DBF01/vista/html/venta.html">Ventas</a></li>' +
                    '<li class="dropdown">' +
                    '<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">Administrar <span class="caret"></span></a>' +
                    '<ul class="dropdown-menu" role="menu">' +
                    '<li><a href = "http://localhost/DBF01/vista/html/usuario.html">Usuarios</a></li>' +
                    '<li><a href = "http://localhost/DBF01/vista/html/cliente.html">Clientes</a></li>' +
                    '<li><a href = "http://localhost/DBF01/vista/html/producto.html">Productos</a></li>' +
                    '<li><a href = "http://localhost/DBF01/vista/html/factura.html">Facturas</a></li>' +
                    '<li class="divider"></li>' +
                    '<li><a href = "http://localhost/DBF01/vista/html/tiposCliente.html">Tipos de Cliente</a></li>' +
                    '<li><a href = "http://localhost/DBF01/vista/html/tiposFactura.html">Tipos de Factura</a></li>' +
                    '</ul>' +
                    '</li>' +
                    '</ul>' +
        ...
        app.login = function () {
            var url = "http://localhost/DBF01/controlador/ruteador/Ruteador.php?accion=login";
        ...
        app.logout = function (data) {
            ...
            var url = "http://localhost/DBF01/controlador/ruteador/Ruteador.php?accion=logout&formulario=Sesion";
            $.ajax({
                url: url,
                method: 'POST',
                dataType: 'text',
